...
urlpatterns = [
     ...
     path('activities/<int:activity_id>/prices/add/', views.add_activity_price, name='add_activity_price'),
    ...
    path('vehicles/delete/<int:vehicle_id>/', views.delete_vehicle, name='delete_vehicle'),
     ...
     path('vehicle/<int:vehicle_id>/pricing/', views.vehicle_pricing_list, name='vehicle_pricing_list'),
     path('vehicle/<int:vehicle_id>/pricing/add/', views.add_vehicle_pricing, name='add_vehicle_pricing'),
     path('vehicle/<int:vehicle_id>/pricing/edit/<int:price_id>/', views.edit_vehicle_pricing, name='edit_vehicle_pricing'),
     path('vehicle/<int:vehicle_id>/pricing/delete/<int:price_id>/', views.delete_vehicle_pricing, name='delete_vehicle_pricing'),
     ...
     path('houseboat/<int:houseboat_id>/valid-options/', views.get_valid_houseboat_options_itinerary,name='get_valid_houseboat_options_itinerary'),
     ...
     path('hotel/<int:hotel_id>/valid-options/', views.get_valid_hotel_options, name='get_valid_hotel_options'),
     ...
     path('inclusions/<int:inclusion_id>/delete/', views.delete_hotel_inclusion, name='delete_hotel_inclusion'),
     path('inclusions/<int:inclusion_id>/edit/', views.edit_hotel_inclusion, name='edit_hotel_inclusion'),
     path('inclusions/<int:inclusion_id>/toggle/', views.toggle_inclusion_availability, name='toggle_inclusion_availability'),
